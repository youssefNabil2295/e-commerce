...
window.open  (  data.session.url , '_blank' )
  ...
  return <div className='container mt-4 p-3 justify-content-center align-items-center vh-100'>
    <Helmet>
      ...
      <meta name="description" content="Complete your order by entering your shipping details and selecting a payment method." />
    </Helmet>
    ...
    <form >
      ...
      <textarea  id='Details' type="text"  placeholder='details' className=' mb-2  form-control'/> 
        ...
        <i className="fa-solid fa-money-bill-1-wave fa-beat fa-lg m-2" style={{color:"#ffffff"}}></i>
        Confirm Cash Payment</button>
        <button  type= 'button' onClick={ConfirmOnlinePayment } className='mb-2 m-2 btn btn-primary'>
        
        <i className="fa-regular fa-credit-card fa-flip m-2 fa-lg" style={{color: "#ffffff"}}></i>
